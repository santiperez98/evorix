...
import image1 from '../../../public/mundo.webp';
...
const CallToAction = () => {
  ...
  return (
    <section className="relative py-20 overflow-hidden text-center bg-gradient-to-b from-black to-gray-900 via-gray-800 ">
      <div className="absolute top-0 left-0 w-full h-40 bg-gradient-to-r from-cyan-500 via-purple-600 to-pink-500 rounded-b-[50%] overflow-hidden"></div>
